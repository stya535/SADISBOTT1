...
cl = LINETCR.LINE()
cl.login(token="Esse4Z3rsUSgHaP6qbW0.9q2iIcfJltjghJCvoSD1Wa.tTzObzL/pLZiuaGzG5/+EuMsdExhUswGVVNfQ3uzZNE=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EsadDvXr2hWbb9TCfms8.Gmmj/LDUVq+s+BNzSshgka.1tRTXK1UkYD0dRX+y6wFk8gawBDk1OMgLc7a3qZcskI=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EsTCRH9bavtWYFPHQMF7.v3sqF3OksXegXM+EfPH9zW.DBFAO91ZaW/LYIac0u2uBSz1UJWkun4iSBp33duRIrk=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EsoLPxbQsEzZgAT0Arb6.Ys6Rt54R3uUQB5l0F2W3PG.+3iEdSKTjXscB9lnLoZpyzMXL7AGFDkf7bg8TeNj2N4=")
kc.loginResult()

kb = LINETCR.LINE()
kb.login(token="EsUlyopqwqHEtRGTEsG0.rGm4bkvTi4OPdlfDXCAQ8a.TcFXaJOlJ7knVsZtLzttrTx7S/+2Pctx9z1aroQUxQc=")
kb.loginResult()

kd = LINETCR.LINE()
kd.login(token="Es4l5VUeH4eFTb0Hc0e0.baD2tzkPSNo1xDUzkQbIWa.1yTO1XcJXog3bd9uTkX2xlYtiaNPaENS1KwCb350dLc=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="EsbkhdsZJAnLkcjkoFp1.QLyVrn/7ce0rYYmzu5Bcyq.VKPfIYyfX3kUnbvFOA/VOoDj652d3tzhTSd6ZxM866w=")
ke.loginResult()

kg = LINETCR.LINE()
kg.login(token="EsVjQHOCIBqKHf5zMr9e.zieevjMpKYrx8lPQ/O4TxG.6Q9rVWV2qIa7GGLalbW6cVxXNmWLTBklPhTQBfVEcms=")
kg.loginResult()

kh = LINETCR.LINE()
kh.login(token="EswoIFwmjd1Nfqk6fiJe.IHcdJdOCIVBEwGBVw1MeRG.Y6qqcMX9FjR63LkqmOTNRfnwZTed7N5bbISx/KZOjuE=")
kh.loginResult()

sw = LINETCR.LINE()
sw.login(token="EsMCNL04FGsKxGchAMq2.WXc/TGGn50c8rn8CNUdgKG.JvgHKH4fc5K7GyQ7q5JAuDjrX/Yg97hREARhGIUUfMI=")
sw.loginResult()
...
KAC=[cl,ki,kk,kc,kb,kd,ke,kg,kh,sw] 
...
admin = ["ua24c0a637281eb43c2170abe7a606d80","uf50d888821632d32461e37153ac775c0"]
staff = ["ua24c0a637281eb43c2170abe7a606d80","uf50d888821632d32461e37153ac775c0"]
owner =["ua24c0a637281eb43c2170abe7a606d80"]
adminMID = 'ua24c0a637281eb43c2170abe7a606d80','uf50d888821632d32461e37153ac775c0'
wait ={ 
    'contact':False,
    'autoJoin':True,
...
#----------------------------------------------------------------------------------------------
		...
		if wait["goodbye"] == False:
	      ...
	      if msg.from_ in admin:
            	...
            	msg.contentType = 13
                msg.contentMetadata = {'mid': 'ua24c0a637281eb43c2170abe7a606d80'}
                cl.sendMessage(msg)
...
#-----------------------------------------------
	      ...
	      if msg.from_ in admin:
            ...
            elif "Sablenk play" in msg.text:
	      if msg.from_ in admin:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Sablenk play","")
                    gs = ki.getGroup(msg.to)
                    gs = kk.getGroup(msg.to)
		    gs = kc.getGroup(msg.to)
